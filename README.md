...
The COD API supports up to 500 items per page but defaults to 10, and silently
ignores arbitrary date / name filters, which makes naïve LLM workflows chatty.
The aggregation tools handle pagination and filtering server-side:
